    ...
    <div class="row mb-4">
      <div class="col-lg-12 position-relative z-index-2">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Subject Count', value: count.subject_count }"
              detail="Over all subjects"
              :icon="{
                name: 'subject',
                color: 'text-white',
                background: 'info',
           ...
           <div v-if="currentUser.role == 'system_admin'" class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
...
export default {
  ...
  created(){
    ...
    // this.$secured.get('/todos')
    //     .then(response => { console.log(response.data) })
    //     .catch(error => { console.log(error) })

    // this.$secured.get('/admin/users')
    //     .then(response => { console.log( response.data) })
    //     .catch(error => { console.log(error) })
    // this.$store.commit('unsetCurrentUser')
